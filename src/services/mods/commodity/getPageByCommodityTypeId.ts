...
/**
 * @description 根据分类获取商品列表 接口 URL 参数/GET
 */
export class Params {
  /** commodityTypeId */
...
/**
 * @description 根据分类获取商品列表 接口参数
 */
export type GetPageByCommodityTypeIdParams = Params

/**
 * @description 根据分类获取商品列表 接口
 */
...
/**
 * @description 根据分类获取商品列表 hooks 默认的 key
 */
export const USE_GET_PAGE_BY_COMMODITY_TYPE_ID_KEY =
  '/api/commodity/v1/commodity/list/{commodityTypeId}_GET'
